...
> The protocol is one page: **[docs/CITING.md](docs/CITING.md)**. The design
> for correspondence *below* a statement — one clause, one production, one
> premise — is **[docs/ANCHORS.md](docs/ANCHORS.md)**.
